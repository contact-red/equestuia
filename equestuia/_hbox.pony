...
actor HBox is (_WidgetParent & _Resizable)
  """Horizontal box container. Packs children left-to-right."""
  ...
  fun ref _repack() =>
    ...
    let allocs = Packer.pack(Horizontal, _width, _height, hints_and_opts)
